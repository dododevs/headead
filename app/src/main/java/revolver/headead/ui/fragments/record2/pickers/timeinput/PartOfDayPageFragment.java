...
public class PartOfDayPageFragment extends Fragment {

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_time_picker_part_of_day_page, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        view.findViewById(R.id.fragment_time_picker_mode_switch).setOnClickListener(v -> {
            ...
            b.putString("mode", DateTimePickerFragment.TimeInputMode.CLOCK.name());
